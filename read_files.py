...
def process_one_file(
    ...
    # INTERSECTION: high Alpha AND low Beta 
    ...
    #  A) CORE RANGES (10–90% quantiles) + TOP POINTS TO A FILE
    ...
    with open(summary_path, "w") as f:
        ...
        for col in param_cols:
            ...
            if col.startswith("m2"):
                # You scanned as np.linspace(a, b, num)*1000**2
                f.write(
        ...
        # Define a simple "score": high Alpha, low Beta
        a = df_best[alpha_col]
        b = df_best[beta_col]
...
if __name__ == "__main__":
    base = Path("/Users/marthaulloa/Documents/Projects/GW-eta'-mass/F3/N3")
